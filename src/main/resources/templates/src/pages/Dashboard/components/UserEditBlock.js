    ...
    return (
        <form onSubmit={handleSubmit(submitForm)}>
            <div className="d-flex mb-2 mt-3 flex-column align-item-center justify-content-center">
                ...
                <input  className="text-input" type="text" placeholder="Nom" id={"name"} defaultValue={user.name}/>
            </div>
            <div className="d-flex mb-2 mt-3 flex-column align-item-center justify-content-center">
                <label htmlFor="surname"  className={"text-center my-2"} > Prénom</label>
                <input className="text-input" type="text" placeholder="Prénom" id={"surname"} defaultValue={user.surname}/>
            </div>
            <div className="d-flex mb-2 mt-3 flex-column align-item-center justify-content-center">
                <label htmlFor="mail"  className={"text-center my-2"} > Email</label>
                <input className="text-input" type="mail" placeholder="mail" id={"mail"} defaultValue={user.mail}/>
            </div>
            <div className="d-flex mb-2 mt-3 flex-column align-item-center justify-content-center">
                <label htmlFor="cv" className={"text-center my-2"} >
                    Cv
                </label>
                <input id={"cv"}  type="file" placeholder="cv" className="file-input"/>
            </div>
